...
import com.niit.abbss.model.CardDetail;
...
import com.niit.abbss.model.ShippingAddress;
...
public class AppplicationContextConfig {
	...
	public DataSource getDataSource() {
	    ...
	    dataSource.setUrl("jdbc:h2:tcp://localhost/~/himaproject");
